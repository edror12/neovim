...
vim.opt.colorcolumn = "132"                     -- show a guide at column 132
...
vim.opt.scrolloff = 4                           -- keep at least 4 lines visible above/below the cursor
vim.opt.sidescrolloff = 4                       -- keep at least 4 columns visible left/right of the cursor
